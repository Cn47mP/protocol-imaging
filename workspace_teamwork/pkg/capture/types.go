...
var (
	...
	ErrHomingFailed      = errors.New("homing failed to converge to origin")
	ErrCalibrationFailed = errors.New("runtime calibration failed")
	ErrLowConfidence     = errors.New("motion observation confidence below threshold")
	ErrDisplacedAnchor   = errors.New("anchor verification displaced beyond tolerance")
)
...
func (d Direction) Valid() bool {
	switch d {
	case DirectionLeft, DirectionRight, DirectionDown, DirectionUp:
		return true
	default:
		return false
	}
